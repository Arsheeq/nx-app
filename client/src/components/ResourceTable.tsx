...
export const ResourceTable: React.FC = () => {
  ...
  // Handle select all for the current tab
  ...
  // Check if all visible resources are selected
      ...
      <Tabs defaultValue="EC2" className="w-full" onValueChange={(value) => setActiveTab(value as 'EC2' | 'RDS')}>
        ...
        <div className="mt-6">
          ...
          <div className="border rounded-lg overflow-hidden">
            <div className="bg-gray-100 px-4 py-3 text-sm font-medium grid grid-cols-12 gap-4">
            ...
            {filteredResources.length === 0 ? (
              ...
              filteredResources.map((resource) => (
                <div 
                  ...
                  className="px-4 py-3 border-t grid grid-cols-12 gap-4 items-center hover:bg-blue-50/50 transition-colors cursor-pointer"
